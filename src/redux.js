...
import createRootReducer from "./store/reducers/rootReducer"; // Đổi tên import để phù hợp với hàm tạo rootReducer
...
const rootReducer = createRootReducer(history); // Tạo rootReducer với history
